/*! TenVideoPlayer_V2 - v2.0.0 - 2017-07-11 17:49:38
 * Copyright (c) 2017
...
!function (a) {
    ...
    if ("undefined" == typeof a && (window.Zepto = b), function (a) {
            ...
            c = function (a, b) {
                ...
                a = a || {};
                var b = a.url, i = a.callbackParameter || "callback", j = a.data || {}, k = document.createElement("script"), l = a.jsonpCallback || e(), m = "?";
    ...
    "undefined" != typeof b && b._tvp ? (tvp.$ = b, d = !0) : (tvp.$ = {}, d = !1), function () {
        ...
        function b(a) {
            ...
            (c.webkit = !!d) && (c.version = d[1]), e && (b.android = !0, b.version = e[3]), f && (b.android = !0,
        ...
        isUseHtml5: function () {
            ...
            return d = h % e, void 0 == b && (b = 0), c = 0 == b ? ["http://vpic.video.qq.com/", d, "/", a, "_160_90_3.jpg"/*tpa=http://imgcache.qq.com/tencentvideo_v1/tvp/js/_160_90_3.jpg*/].join("") : ["http://vpic.video.qq.com/", d, "/", a, "_", "160_90_", b, "_1.jpg"/*tpa=http://imgcache.qq.com/tencentvideo_v1/tvp/js/_1.jpg*/].join("")
            ...
            var b = {
                ...
                limit_conf: ["limit_conf.js"/*tpa=http://v.qq.com/iframe/limit_conf.js*/, "https://v.qq.com/iframe/limit_conf.js"],
            ...
            var a = "http://imgcache.qq.com/tencentvideo_v1/tvp/js/view.inews.qq.com" === location.host, b = tvp.$;
            ...
            return !tvp.$.browser.MQQClient || "http://imgcache.qq.com/tencentvideo_v1/tvp/js/xiaoqu.qq.com" !== window.location.hostname && "http://imgcache.qq.com/tencentvideo_v1/tvp/js/buluo.qq.com" !== window.location.hostname ? !1 : !0
            ...
            if (!f) {
                ...
                k && -1 === c.inArray(k, ["http://imgcache.qq.com/tencentvideo_v1/tvp/js/v.qq.com", "http://imgcache.qq.com/tencentvideo_v1/tvp/js/film.qq.com", "http://imgcache.qq.com/tencentvideo_v1/tvp/js/m.v.qq.com"]) && (f = k.replace(/\./g, "_"))
            }
        ...
        return "http://imgcache.qq.com/tencentvideo_v1/tvp/js/film.qq.com" == document.location.host && (i = !0), {
            getOcx: function (b) {
                ...
                if (tvp.$.browser.ie)try {
                    ...
                    if (tvp.$.isUndefined(l.namedItem) || (e = "plugs.namedItem", k = l.namedItem("\u817e\u8baf\u89c6\u9891")), !k) {
                        ...
                        for (var m = 0, n = l.length; n > m; m++)if (l[m] && "\u817e\u8baf\u89c6\u9891" == l[m].name || "http://imgcache.qq.com/tencentvideo_v1/tvp/js/npQQLive.dll" == l[m].filename) {
                            k = l[m];
                            break
                        }
                    }
                ...
                if ("0.0.0" != e)return e;
                var a, b = null, c = null, d = [], f = "Shockwave Flash", j = navigator, k = "application/x-shockwave-flash";
                if (tvp.$.browser.ie)try {
        ...
        a.app = {
            config: {
                defaultName: "qqlive",
                QQApiUrl: "qqapi.js"/*tpa=http://pub.idqqimg.com/qqmobile/qqapi.js*/,
                mqqApiUrl: "browser_interface_getCryptext.js"/*tpa=http://res.imtt.qq.com/browser_lightapp/QQBrowserApi/getCryptext/browser_interface_getCryptext.js*/
                ...
                return WeixinJSBridge.invoke("getNetworkType", {}, function (b) {
                    var c = -1;
                    b && b.err_msg && ("network_type:fail" === b.err_msg && (c = 0), "network_type:wifi" === b.err_msg && (c = 1), "network_type:edge" === b.err_msg && (c = 2),
                    "network_type:wwan" === b.err_msg && (c = 3)), a.resolve(c)
                }), a
            }, check: function (d) {
        ...
        html5FeatureExtJS: {adonend: "http://imgcache.qq.com/tencentvideo_v1/tvp/js/plugins/adonend.js?max_age=86400"},
        ...
        rcmdTextReport: function (a, b, c, d) {
            ...
            var c = tvp.common.getCompleteUrlByProtocol("//btrace.video.qq.com/kvcollect?BossId=3267&Pwd=1887953802&"), d = {
                cmd: -1,
                url: window != top ? document.referrer : document.location.href,
                ver: tvp.ver.replace(/\$/g, ""),
                ua: tvp.common.getReportUA && tvp.common.getReportUA(),
        ...
        a.VideoInfo = function () {
            ...
            s ? c.guid = s : (s = b.createGUID(), b.setData("tvp-guid", s), c.guid = s), this.callGetMp4UrlDefer = b.Deferred(), b.each(o, function (a) {
                ...
                var b = [];
                return b[0] = a.common.getVideoSnap(h, k), b[1] = b[0].replace("_160_90_3", "_1"), b[2] = b[1].replace("_1.jpg"/*tpa=http://imgcache.qq.com/tencentvideo_v1/tvp/js/_1.jpg*/, ".png"), b
    ...
    e.ha = function (a) {
        ...
        var j = e.hexToString(e.ha(a + b + f + e._Seed + g + h + d.charAt(0) + c)), k = e.urlenc(e.tempcalc(j, e._Seed), d.charAt(0), f), l = e.urlenc(e.tempcalc(j, "86FG@hdf"), d.charAt(0), f), m = e.u1(k, 0), n = e.u1(k, 1);
        ...
        var d = [{
            ...
            reg: function () {
                if (window !== top && "http://imgcache.qq.com/tencentvideo_v1/tvp/js/v.qq.com" === location.hostname && "http://imgcache.qq.com/iframe/player.html" === location.pathname) {
                ...
                var d, e, f = this, g = "undefined" != typeof f.cfg.svr_time ? f.cfg.svr_time + "" : parseInt(+new Date / 1e3) + "", h = function () {
                    ...
                    e.timestamp = g, b.os.ios ? (a = x5.ios.getBrowserSignature, d = b.os.ipad ? e : "vid:" + e.vid + "[" + e.timestamp + "]") : (a = x5.android.getBrowserSignature, d = "vid:" + e.vid + "[" + e.timestamp + "]"), a(d, function (a) {
                        if ("object" == typeof a && a.key && a.ver && a.platform) {
                            ...
                            var b = {
                                cgi: f.cfg.cgi.getvinfo,
                                param: {cKey: a, encryptVer: "4.0", platform: "161001", vid: f.cfg.vid, defn: f.cfg.fmt}
                            };
                            c.resolve(b)
                        } else c.reject()
                    }, function () {
            ...
            reg: function () {
                ...
                var l = function () {
                    var a = {
                        ...
                        args: [g, h, i],
                        instanceName: "TencentNewsScriptControllerJsInterface"
                    }, b = "jsbridge://get_with_json_data?json=" + encodeURIComponent(JSON.stringify(a)) + "&_t=" + h, c = new Image;
                    c.src = b
                }, m = function () {
                    var a = function () {
                        ...
                        if (a && -1 !== a) {
                            var d = {
                                cgi: c.cfg2.cgi.getvinfo, param: {
                                    cKey: a, encryptVer: "6.4", platform: "170101", vid: c.cfg.vid, defn: c.cfg.fmt
                                }
                            };
                            b.resolve(d)
                        }
        ...
        function c() {
            var a = "http://imgcache.qq.com/tencentvideo_v1/tvp/js/view.inews.qq.com" === k.host;
            return location.hostname.indexOf("http://imgcache.qq.com/tencentvideo_v1/tvp/js/caixin.com") > -1 ? "v1093" : b.os.iphone || b.os.ipod ? a ? "v3110" : "v3010" : b.os.ipad ? a ? "v4110" : "v4010" : b.os.android ? b.os.tablet ? "v6010" : a ? "v5110" : "v5010" : b.browser.IEMobile ? "v7010" : "v1010"
        }
        ...
        k.cgi = function () {
            if ("http://imgcache.qq.com/tencentvideo_v1/tvp/js/view.inews.qq.com" === k.host) {
                var c = "";
            ...
            loadVideoUrlByVid: function (c) {
                ...
                var A = function (d) {
                    ...
                    var h, k = l.ul.ui[0];
                    o.br = l.br, o.path = k.url, o.fn = l.fn, o.fiid = d(n, f.fl.fi), o.vt = k.vt, h = new a.RetCode(100127), h.begin(), v = b.now();
                    var m = a.common.getTimeStampStr(), s = {
                        otype: "json",
                        vid: n.vid,
                        format: o.fiid,
                        filename: o.fn,
                    ...
                    n.commonAuthData && (n.commonAuthData.auth_from || n.commonAuthData.auth_ext) && (n.commonAuthData.auth_from && (r.auth_from = n.commonAuthData.auth_from), n.commonAuthData.auth_ext && (r.auth_ext = n.commonAuthData.auth_ext)), x = z + b.param(s), x = j(x, m), y = i({
                        itype: 2,
                        val2: t ? 1 : 0,
                        str3: x,
                        vid: n.vid,
                        ...
                        var d = "";
                        return p = 0, w = b.now() - v, a && a.s ? "o" != a.s && (p = a.em || 50) : p = 50, 0 != p ? (h.reportErr(p), y({
                            val: p,
                            speed: w
                        }), void q.reject(p)) : (d = g({
                            path: o.path,
                            ...
                            vid: n.vid,
                            alias: l.alias
                        }), h.reportSuc(), y({val: 0, speed: w}), void q.resolve(d, {
                            vl: f.vl,
                            fl: f.fl,
                            sfl: f.sfl,
                            exem: f.exem,
                        ...
                        h.reportErr(), y({
                            val: 500,
                            speed: b.now() - v
                        }), t ? q.reject(500, 2) : (e.retryDefer = q, a.h5Helper.loadVideoUrlByVid(e))
                    })
                }, C = function () {
                    var c = a.common.getTimeStampStr();
                    r._rnd = c, x = u + b.param(r), f && "object" === b.type(f) && (x += "&" + b.param(f)), x = j(x, c), b.ajax({
                        url: x,
                        dataType: "jsonp",
                        ...
                        if (!e.noAuth && c && 0 != c.em && "o" != c.s) {
                            ...
                            if (83 === c.em && r.eduext); else if (!(b.inArray(c.em, [100]) > -1))return e.noAuth = !0, e.defer = q, void a.h5Helper.loadVideoUrlByVid(e)
                        }
                        A(c)
                    }).fail(function () {
                        if (s.reportErr(), y({val: 500, speed: b.now() - v}), t)q.reject(500, 1); else {
                ...
                return e.cgi_auth_index || (e.cgi_auth_index = 1), a.auth(n, k).done(function (a) {
                    a = a || {}, "undefined" !== b.type(a.cgi) && a.cgi && (u = a.cgi), "undefined" !== b.type(a.cgi2) && a.cgi2 && (z = a.cgi2), a.param && b.extend(r, a.param), C()
                }).fail(function () {
                    b.extend(r, {vids: n.vid, defaultfmt: n.fmt}), C()
                }), q
        ...
        if (!window.txvLogin) {
            ...
            }, e = navigator.userAgent.toLowerCase(), f = {
            ...
            a.prototype = {
                isLogin: function (a) {
                    ...
                    if (c += "?t=" + +new Date, "http://imgcache.qq.com/tencentvideo_v1/tvp/js/qq.com" !== document.domain)return void a({error: "document.domain\u4e0d\u7b49\u4e8eqq.com\uff0c\u8de8\u57df\u5931\u8d25"});
                    ...
                    var b = "//video.qq.com/fcgi-bin/check_login", c = d.ajax({
                        url: b,
                        timeout: 5e3,
                        dataType: "jsonp"
                    }, function (b) {
    ...
    f.log = tvp.log, f.debug = function (a) {
        ...
        CTRLSWF_URL: "vodCtrl.swf"/*tpa=http://imgcache.qq.com/liveportal_v1/swf/player/vodCtrl.swf*/,
        CTRLSWF_VOD_URL: "vodCtrl_drm.swf"/*tpa=http://imgcache.qq.com/liveportal_v1/swf/player/vodCtrl_drm.swf*/,
        CTRLSWF_W_URL: "vodCtrl_w.swf"/*tpa=http://imgcache.qq.com/liveportal_v1/swf/player/vodCtrl_w.swf*/,
        PREVIEW_URL: "qqlive_logo.swf"/*tpa=http://imgcache.qq.com/liveportal_v1/swf/player/qqlive_logo.swf*/,
        LOADING_URL: "loadstart.swf"/*tpa=http://imgcache.qq.com/liveportal_v1/swf/player/loadstart.swf*/,
        AD_SWF_URL: "moneyplayer.swf"/*tpa=http://imgcache.qq.com/liveportal_v1/swf/player/moneyplayer.swf*/,
        ...
        function a(a) {
            ...
            if (/\d+/i.test(a)) {
                var b = parseInt(a / 1e4 / 100, 10), c = parseInt(a / 1e4, 10) - 100 * b, d = parseInt(a, 10) - (100 * b * 1e4 + 1e4 * c);
        ...
        timer: null, installerObj: null, getInstallerHtml: function () {
            ...
            if (tvp.$.browser.ie)try {
                ...
                try {
                    if (c.CreateAX("http://imgcache.qq.com/tencentvideo_v1/tvp/js/MMInstall.dll"), "undefined" != typeof c.GetVersionByClsid)return !0;
                    try {
        ...
        rptImg: null, bind: function (a, b) {
            ...
            c && ("function" == typeof pgvSendClick ? pgvSendClick({
                hottag: "OCX.SETUP." + a,
                virtualURL: "http://imgcache.qq.com/virtual/ocx.html",
                virtualDomain: "http://imgcache.qq.com/tencentvideo_v1/tvp/js/v.qq.com"
    ...
    f.DEFINE = {
        ...
        var h = b.now(), i = ["\u672a\u6307\u660e\u64ad\u653e\u5668\u5185\u6838", "\u60a8\u5f53\u524d\u4f7f\u7528\u7684\u7edf\u4e00\u64ad\u653e\u5668JS\u6587\u4ef6\u4e0d\u5305\u542b\u6307\u5b9a\u7684\u64ad\u653e\u5668\u5185\u6838", "video\u672a\u521d\u59cb\u5316"], j = function (c, d) {
            function f() {
                var a = b.Deferred();
                switch (r.playerType) {
                    case"flash":
            ...
            function h() {
                var b = navigator.platform.toLowerCase(), c = navigator.userAgent.toLowerCase(), d = a.version.getFlashMain(), e = /ipad|ipod|iphone|lepad_hls|IEMobile|WPDesktop/gi.test(c), f = (/MacIntel/gi.test(b), /ipad|ipod|iphone|playstation/gi.test(b));
                return a.common.isEnforceMP4() ? void(t = "MP4Link") : e || f || a.$.os.android ? void(a.common.isSupportMP4() || a.common.isInUseH5() ? m() : t = "MP4Link") : a.$.os.Mac && "http://imgcache.qq.com/tencentvideo_v1/tvp/js/film.qq.com" === location.hostname ? void(t = "FlashPlayer") : a.$.os.Mac && (10 > d || !d) && a.common.isSupportMP4() ? void m() : void(t = "FlashPlayer")
            }
            ...
            function o(a) {
                for (var b = !1, c = document.getElementsByTagName("link") || [], d = 0, e = c.length; e > d && !(b = c[d] && c[d].href && (c[d].href.indexOf(a) > 0 || -1 != c[d].href.indexOf("player_inews.css"/*tpa=http://imgcache.qq.com/tencentvideo_v1/tvp/js/player_inews.css*/)));)d++;
                return b
            }
            ...
            function p() {
                ...
                var e = null, f = !1, h = b.inArray(t, w), i = r.cssPath + (c.HTML5CSSName || "player.css"/*tpa=http://imgcache.qq.com/tencentvideo_v1/tvp/js/player.css*/);
                ...
                var g = function () {
                    j(f.config, f).done(function (d, g) {
                        ...
                        d.callCBEvent("onwrite"), f.config.type == a.PLAYER_DEFINE.LIVE && (f.play = function (c) {
                            b.isString(c) ? (f.config.video.setChannelId(c), c = f.config.video) : c instanceof a.VideoInfo && b.when(j.checkLivePlayer(c)).then(function () {
                    ...
                    var c, d = b.Deferred(), e = "tvp.config.js"/*tpa=http://v.qq.com/iframe/tvp.config.js*/;
    ...
    }(tvp.$), tvp.filename = "tvp.player_v2.js"/*tpa=http://imgcache.qq.com/tencentvideo_v1/tvp/js/tvp.player_v2.js*/, "function" == typeof define && define("tvp", [], function () {
        return tvp
